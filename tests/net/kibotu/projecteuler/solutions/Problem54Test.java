...
import static net.kibotu.projecteuler.solutions.Problem54.Consts;
...
public class Problem54Test {
    ...
    public void testCards() {
        ...
        try {
            ...
            Problem54.Card c1 = p.new Card("8C");
            Problem54.Card c2 = p.new Card("9C");
            Problem54.Card c3 = p.new Card("9H");
    ...
    public void testRoyalFlush() {
        ...
        try {
            p = new Problem54("pokertst.txt");
            Problem54.Hand h1 = p.new Hand("AC JC QC KC TC", true);
    ...
    public void testStraightFlush() {
        ...
        try {
            p = new Problem54("pokertst.txt");
            Problem54.Hand h1 = p.new Hand("KC QC JC TC 9C", true);
    ...
    public void testFours() {
        ...
        try {
            p = new Problem54("pokertst.txt");
            Problem54.Hand h1 = p.new Hand("KC KH KS KD 9D", true);
    ...
    public void testFullHouse() {
        ...
        try {
            p = new Problem54("pokertst.txt");
            Problem54.Hand h1 = p.new Hand("KH KD KC TC TD", true);
    ...
    public void testFlush() {
        ...
        try {
            p = new Problem54("pokertst.txt");
            Problem54.Hand h1 = p.new Hand("4H QH 2H TH AH", true);
    ...
    public void testStraight() {
        ...
        try {
            p = new Problem54("pokertst.txt");
            Problem54.Hand h1 = p.new Hand("KH QD JH TC 9C", true);
    ...
    public void testThrees() {
        ...
        try {
            p = new Problem54("pokertst.txt");
            Problem54.Hand h1 = p.new Hand("KH KD KS TH 9C", true);
    ...
    public void testTwoPairs() {
        ...
        try {
            p = new Problem54("pokertst.txt");
            Problem54.Hand h1 = p.new Hand("KH KD QS QH 9C", true);
    ...
    public void testPair() {
        ...
        try {
            p = new Problem54("pokertst.txt");
            Problem54.Hand h1 = p.new Hand("KH KD 3S 2H 9C", true);
