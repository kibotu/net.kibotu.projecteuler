...
import net.kibotu.projecteuler.utils.Primes;
 ...
 * <p>SOLVED</p>
 * <p/>
 * <p>We shall say that an n-digit number is pandigital if it makes use of all the digits 1 to n exactly once.
 * For example, 2143 is a 4-digit pandigital and is also prime.</p>
 * <p/>
...
public class Problem41 {
    ...
    public static void main(String[] args) {
        System.out.println("Permutations Prime: " + getSolution());
    }
