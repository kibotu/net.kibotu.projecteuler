...
import net.kibotu.projecteuler.utils.ArrayList;
...
public class Problem54 {
    ...
    enum Consts {
        ...
        public static final String[] ColorStrings = new String[]{"", "Diamond", "Club", "Spade"};
        public static final String[] ValueStrings = new String[]{"", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Ten", "Jack", "Queen", "King", "Ace"};
        public static final String[] PlayStrings = new String[]{"", "Pair", "Two Pairs", "Three", "Straight", "Flush", "Full House", "Fours", "Straight Flush", "Royal Flush"};
    }
    ...
    public class Card implements Comparable<Object> {
        ...
        private void setColor(char c) {
            switch (c) {
                case 'H':
                    color = Consts.ColorHeart;
                    break;
                case 'C':
                    color = Consts.ColorClub;
                    break;
                case 'S':
                    color = Consts.ColorSpade;
                    break;
                case 'D':
                    color = Consts.ColorDiamond;
                    break;
                default:
        ...
        private void setValue(char v) {
            switch (v) {
                case 'A':
                    value = Consts.ValueAce;
                    break;
                case '2':
                    value = Consts.ValueTwo;
                    break;
                case '3':
                    value = Consts.ValueThree;
                    break;
                case '4':
                    value = Consts.ValueFour;
                    break;
                case '5':
                    value = Consts.ValueFive;
                    break;
                case '6':
                    value = Consts.ValueSix;
                    break;
                case '7':
                    value = Consts.ValueSeven;
                    break;
                case '8':
                    value = Consts.ValueEight;
                    break;
                case '9':
                    value = Consts.ValueNine;
                    break;
                case 'T':
                    value = Consts.ValueTen;
                    break;
                case 'J':
                    value = Consts.ValueJack;
                    break;
                case 'Q':
                    value = Consts.ValueQueen;
                    break;
                case 'K':
                    value = Consts.ValueKing;
                    break;
                default:
                    throw new IllegalArgumentException("");
            }
         ...
         */
        public String toString() {
            return "" + Consts.ValueStrings[value] + "" + Consts.ColorStrings[color] + "s";
        }
     ...
     * @throws java.io.IOException if file was unreadable
     */
    public Problem54(String filename) throws IOException {
        ...
        File f = new File("" + File.separator + "problem_54" + File.separator + filename);
